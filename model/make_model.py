...
class PATNetwork(nn.Module):
    ...
    def forward(self, input):
        ...
        fpose = self.pose_encoder(pose12)
...
if __name__ == '__main__':
    ...
    input2 = torch.randn((1, 36, 128, 64)).to('cuda')
