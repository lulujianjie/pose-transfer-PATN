...
MISSING_VALUE = -1
split='test'
#img_dir = '/data_2/lujj/datasets/Market-1501-v15.09.15/bounding_box_test'  # raw image path
annotations_file = '/home/lujj/datasets/Market-1501-v15.09.15/market-annotation-{}.csv'.format(split)  # pose annotation path
save_path = '/home/lujj/datasets/Market-1501-v15.09.15/{}_pose_heatmap'.format(split)  # path to store pose maps
