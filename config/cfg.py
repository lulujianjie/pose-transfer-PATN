...
Cfg.MODEL.NUM_BLOCKS_PATN = 9
Cfg.MODEL.NUM_BLOCKS_RESNET = 6
Cfg.MODEL.DEVICE_ID = "7"#
...
Cfg.SOLVER.STEPS = [30,70,100,150, 200, 300, 400, 500, 600, 700]
...
Cfg.SOLVER.MAX_EPOCHS = 800

Cfg.TEST = cfg()
Cfg.TEST.BATCHSIZE = 128
Cfg.TEST.WEIGHT = "./log/model_G_800.pth"
